...
**Pending Phase 9 + Phase 10.** The harness package and the af-only smoke tests have not yet migrated. Until they do, treat the relevant files in the internal platform harness as the operational reference for harness shape:
